...
export default async function getAggregates() {
  try {
    ...
    const result = await axios(
      `https://api.polygon.io/v2/aggs/ticker/AAPL/range/1/day/2023-09-01/2023-11-10?adjusted=true&sort=asc&limit=120&apiKey=${process.env.NEXT_PUBLIC_POLYGON_API_KEY}`,
    );
